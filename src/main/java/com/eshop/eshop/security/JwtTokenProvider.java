...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new EshopAPIException(HttpStatus.BAD_REQUEST,"Expired JWT token");
        } catch (UnsupportedJwtException unsupportedJwtException) {
            throw new EshopAPIException(HttpStatus.BAD_REQUEST,"Unsupported JWT token");
        } catch (IllegalArgumentException illegalArgumentException){
            throw new EshopAPIException(HttpStatus.BAD_REQUEST,"Jwt claims string is null or empty");
        }
    }
}